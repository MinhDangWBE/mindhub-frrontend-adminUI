...
(function () {
  ...
  function createOrGetMobileOverlay() {
    ...
    if (!overlay) {
      ...
      overlay.className =
        "fixed inset-0 z-40 bg-black/40 hidden transition-opacity duration-300 lg:hidden";
  ...
  function initSidebarToggle() {
    ...
    if (window.__mindhubSidebarInited) {
      return true;
    }
  ...
  document.addEventListener("mindhub:layout-ready", initSidebarToggle);
